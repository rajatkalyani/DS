...
os.chdir("/Users/rajatpa/Documents/DS/StatisticsforMachineLearning_Code/Chapter01")
...
'''
Quartile: “This is one-fourth of the data, and also is the 25th percentile.
The first quartile “is 25 percent of the data.
The Second quartile “is 50 percent of the data.
The Third quartile “is 75 percent of the data.
The Fourth quartile “is 100 percent of the data.

The Inter quartile range is the distance between Third quartile  and first quartile
...
survey = pd.read_csv("/Users/rajatpa/Documents/DS/StatisticsforMachineLearning_Code/Chapter01/survey.csv")
...
# need to understand the contingency code.

#ANOVA
import pandas as pd
from scipy import stats

fetilizers = pd.read_csv("/Users/rajatpa/Documents/DS/StatisticsforMachineLearning_Code/Chapter01/fetilizers.csv")
...
original_data = pd.read_csv("/Users/rajatpa/Documents/DS/StatisticsforMachineLearning_Code/Chapter01/mtcars.csv")     

#train_data,test_data = train_test_split(original_data,train_size = 0.7,random_state=42)
train_data,test_data = train_test_split(original_data,train_size = 0.7,test_size = 0.3,random_state=42)
...
train_data = pd.read_csv("/Users/rajatpa/Documents/DS/StatisticsforMachineLearning_Code/Chapter01/mtcars.csv") 
type(train_data)
train_data.head(10)                     
