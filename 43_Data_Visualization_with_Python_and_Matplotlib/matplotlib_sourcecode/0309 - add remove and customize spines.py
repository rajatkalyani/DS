...
##                                                          converters={0: bytespdate2num('%Y%m%d')})
    ...
    ax1.fill_between(date, closep, 83.85, where=(closep >= 83.85), facecolor='g', alpha = 0.5)
    ax1.fill_between(date, closep, 83.65, where=(closep <= 83.65), facecolor='r', alpha = 0.5)
